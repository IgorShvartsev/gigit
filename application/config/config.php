...
|--------------------------------------------------------------------------
|
| Used as site name in email headers etc.
|
*/
$config['site_name'] = 'Gigit';
...
|--------------------------------------------------------------------------
|
| Used as site email in email headers etc. For example, dontreply@site.com
|
*/
$config['site_email'] = 'no-reply@gigit.com';
...
|
*/
$config['encryption_key'] = md5($_SERVER['HTTP_HOST']."DFy234Lki0987ge12");
