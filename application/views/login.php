        ...
        <div id="content">
            <form id="login-form" method="post" action="<?=base_url('login');?>" autocomplete="off">
                ...
                <div class="fcb">
                    ...
                    <a href="<?=base_url('authsocials/provider/facebook?redirect=login');?>" onclick="window.open(this.href, 'auth', 'width=600,height=400'); return false;"><img src="<?=base_url('assets/images/default/ifacebook.png')?>" alt="facebook" /></a>
                    <br /><br />
